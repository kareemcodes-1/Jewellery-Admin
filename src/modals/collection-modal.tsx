...
const CollectionModal = ({setOpenDialog}: {setOpenDialog: () => void;}) => {
  ...
  return (
    <DialogContent>
    <DialogHeader>
      <DialogTitle className="lg:mb-0 mb-[1rem]">{editingMode ? 'Edit': 'Create'} Collection</DialogTitle>
  <form action={formAction}  className="space-y-6">
  <div>
    <Label htmlFor="name" className="text-start flex">Name</Label>
    <div className="mt-2">
      <Input       
         id="name"
        name="name"
  ...
  <div>
    <div className="flex items-center justify-between">
      <Label htmlFor="description" className="text-start flex">Description</Label>
    </div>
    <div className="mt-2">
      <Input       
         id="description"
